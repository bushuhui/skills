...
```powershell
python -X utf8 C:\Users\neulzy\.codex\skills\.system\skill-creator\scripts\generate_openai_yaml.py <path-to-office-pyword> --interface 'display_name=PyWord' --interface 'short_description=基于现有 Python 脚本体系的 Word 自动化开发与复用助手' --interface 'default_prompt=Use $office-pyword to inspect the bundled docs/ and scripts/ before solving a Python Word automation task.'

python -X utf8 C:\Users\neulzy\.codex\skills\.system\skill-creator\scripts\quick_validate.py <path-to-office-pyword>
```
