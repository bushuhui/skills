...
- `references/evolution-protocol.md` — 自进化基线 + Compaction 状态保护
- `references/p9-protocol.md` — P9 Tech Lead 管理模式
- `references/p7-protocol.md` — P7 骨干执行模式
- `references/p10-protocol.md` — P10 CTO 战略模式
- `references/harness-governance.md` — 四权分离 + 防作弊 + Task Contract
- `references/survey.md` — 用户反馈收集协议
- `references/teardown-protocol.md` — 主动拆除无用配置/代码
