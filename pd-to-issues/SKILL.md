...
If a PRD has just been published via `/pd-to-prd`, work from that PRD issue — it already contains the problem statement, user stories, implementation decisions, and out-of-scope items structured for breakdown.
